...
export function Footer() {
    return (
        <footer id="contato" className="bg-green-950 mt-32 mobile:mt-10 flex flex-row justify-evenly w-[100vw] py-14 px-[10%] gap-[10px] mobile:flex-col mobile:gap-[23px] mobile:px-4">
            ...
            <ul className="flex flex-col items-start list-none gap-6">
                <Link target="_blank" href={'https://github.com/marcossdev04'}>
                ...
                <Link target="_blank" href={'mailto:marcosdev04@gmail.com'}>
                    <li className="flex items-center gap-6 mobile:gap-2">
                        <MdEmail size={40} />
