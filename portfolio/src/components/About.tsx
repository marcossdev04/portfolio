...
export function About() {
    return (
        <section id="sobre" className="relative bg-[rgba(12,12,12,0.6)] rounded-2xl p-20 mt-32 z-10 ml-[10%] mr-[10%] mobile:bg-transparent mobile:px-0">
            <h2 className="text-4xl font-bold tracking-wider text-white">Sobre</h2>
            <div className="flex items-center mobile:flex-col">
                <Image src={avatar} alt="avatar" className="w-[40%] mt-10 mobile:hidden" />
                <ul className="text-white flex flex-col gap-[50px] mt-7">
                    <li className="flex items-center rounded-3xl list-none p-6 bg-no-repeat bg-transparent transition-colors duration-300 ease-in-out hover:bg-green-700 mobile:px-0" >
